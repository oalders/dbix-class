...
### apt-get invocation - faster to grab everything at once
  ...
  apt_install memcached firebird2.5-super firebird2.5-dev expect libnss-db oracle-xe strace
...
$(which bash) -c "sudo $(which strace) -f -- $(which expect) -c '$EXPECT_ORA_SCRIPT'"
